...
pyspark_job_file_path = 'gs://public_pipe_data/spark_job.py'
...
submit_pyspark_job = DataprocSubmitPySparkJobOperator(
    ...
    dag=dag,
    dataproc_jars=['gs://public_pipe_data/jars/spark-snowflake_2.12-2.15.0-spark_3.2.jar','gs://public_pipe_data/jars/snowflake-jdbc-3.16.0.jar']
)
